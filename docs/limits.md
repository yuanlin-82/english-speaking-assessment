...
5. **Not production config** — weights, prompts, audio, RMSE tables, and lexicons stay private ([NOTICE.md](../NOTICE.md)).
6. **Fluency is hard on short speech** — composition and UI should expose uncertainty, not fake precision.
7. **Expert alignment is ongoing** — “self-built fluency” implies a validation burden; publishing the chain is not the same as publishing a frozen model.
